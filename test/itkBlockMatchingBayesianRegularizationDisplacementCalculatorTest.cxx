...
int
itkBlockMatchingBayesianRegularizationDisplacementCalculatorTest(int argc, char * argv[])
{
  if (argc < 4)
  {
  ...
  using DisplacmentRegularizerType =
    itk::BlockMatching::BayesianRegularizationDisplacementCalculator<MetricImageType, DisplacementImageType>;
